...
import { api, type Category, type Product, type PaymentMethod, ApiError } from "@/lib/warung/api";
...
export function PosScreen() {
  ...
  async function checkout() {
    ...
    try {
      ...
      toast.success(`Transaksi sukses · ${formatRupiah(total)}`);
      setCart([]);
      setCashGiven(0);
      await load();
    } catch (e) {
      toast.error(e instanceof ApiError ? e.message : "Transaksi gagal");
    } finally {
      setSubmitting(false);
    }
  }
